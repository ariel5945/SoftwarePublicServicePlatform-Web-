<template>
  <main>
    <div class="main-body">
      ...
      <div class="form-con">
        <div class="dl-tab">
          <img v-if="regTab === 2" @click="regTab = 1" src="./../../assets/image/pc-login.png" alt="">
          <img v-if="regTab === 1" src="./../../assets/image/wx-login.png" alt="">
        </div>

        <div class="login-type">
          <h4 :class="{'act-h4': emailForm.roleType === 'register_user_role'}" @click="emailForm.roleType = 'register_user_role'">个人注册</h4>
          <h4 :class="{'act-h4': emailForm.roleType === 'no_company_role'}" @click="emailForm.roleType = 'no_company_role'">企业注册</h4>
        </div>
        ...
        <el-form :model="emailForm" :rules="emailRules" ref="emailForm">
          ...
          <el-form-item prop="pwd">
            <el-input maxlength="50" type="password" placeholder="请输入您的登录密码" v-model="emailForm.pwd"></el-input>
          </el-form-item>
          <el-form-item prop="pwd1">
            <el-input maxlength="50" type="password" placeholder="请再次输入您的登录密码" v-model="emailForm.pwd1"></el-input>
          </el-form-item>
          <el-form-item>
            <div>
              <el-checkbox v-model="checked">我已阅读并同意 </el-checkbox>
              <router-link style="color: #3291F8;border-bottom: 1px #3291F8 dashed" to="/registrationProtocol">《洛阳软件公共服务平台注册协议》</router-link>
            </div>

          </el-form-item>
          <el-form-item>
            <div class="login-btn" @click.prevent="submitForm('emailForm')">立即注册</div>
          </el-form-item>
        </el-form>

        <div class="wx-login-con" v-show="regTab === 2">
          <div>
